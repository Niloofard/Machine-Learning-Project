...
@register_model
def Mamba_small(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay= None, **kwargs):
    model = Mamba(stem_chs=[64, 32, 64],
                   depths=[2, 2, 6, 2],
                   dims=[64, 128, 256, 512],
                   path_dropout=0.1, **kwargs)
...
@register_model
def Mamba_base(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay= None, **kwargs):
    model = Mamba(stem_chs=[64, 32, 64],
                   depths=[2, 2, 6, 2],
                   dims=[96, 192, 384, 768],
...
@register_model
def Mamba_large(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay= None, **kwargs):
